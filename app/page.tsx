...
{/* child */}
<div className="bg-primary-foreground p-4 rounded-md lg:col-span-2"><AppBarChart/></div>
...
<div className="bg-primary-foreground p-4 rounded-md lg:col-span-2 "><AppAreaChart/></div>
